...
const FooterEnd = () => {
  return (
    <div className="a-container pb-5" data-v-6e333a11="">
      <hr className="a-divider my-5 mt-3" aria-hidden="true" />
      <div className="flex items-center justify-between">
        <small className="text-2 text-grays-400">
          کلیه حقوق این سرویس (وب‌سایت و اپلیکیشن‌های موبایل) محفوظ و متعلق به
          شرکت سفرهای علی‌بابا می‌باشد. <span dir="ltr"> (نسخه 2.35.2) </span>
        </small>
        <div className="text-center">
          <a
            href="https://t.me/AlibabaTravels"
            className="mx-4 text-grays-400 hover:text-blue-600 inline-block align-middle text-center w-5"
          ...
          <a
            href="https://www.youtube.com/channel/UChN_55cq3XLPUUv7RRzlNgQ"
            className="mx-4 text-grays-400 hover:text-blue-600 inline-block align-middle text-center w-5"
            rel="noopener noreferrer"
            target="_blank"
          >
          ...
          <a
            href="https://twitter.com/alibaba_travels"
            className="mx-4 text-grays-400 hover:text-blue-600 inline-block align-middle text-center w-5"
            rel="noopener noreferrer"
            target="_blank"
          >
          ...
          <a
            href="https://www.aparat.com/alibaba_travels"
            className="mx-4 text-grays-400 hover:text-blue-600 inline-block align-middle text-center w-5"
            rel="noopener noreferrer"
            target="_blank"
          >
          ...
          <a
            href="https://instagram.com/alibaba_travels"
            className="mx-4 text-grays-400 hover:text-blue-600 inline-block align-middle text-center w-5"
            rel="noopener noreferrer"
            target="_blank"
          >
          ...
          <a
            href="https://www.linkedin.com/company/alibaba-travels"
            className="mx-4 text-grays-400 hover:text-blue-600 inline-block align-middle text-center w-5"
            rel="noopener noreferrer"
            target="_blank"
          >
