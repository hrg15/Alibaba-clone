...
const ProductTab = () => {
  return (
    <div className="a-card product-box ">
      <div className="product-tab-box">
        <ul className="tab-links">
          <li className="is-active">
            <Link className="tab-links-item" href="/">
              <svg
                viewBox="0 0 24 24"
                width="36px"
                height="36px"
          ...
          <li
            ...
            role="none"
            style={{
              transform: "translateX(-130px) scaleX(1.152)",
              visibility: "visible",
            }}
          ></li>
        </ul>
        ...
        <div className="tabPanel">
          <form action="#">
            <div className="flex w-full justify-start mb-5 ">
              <span className="a-pill-dropdown inline-block">
                <button type="button" className="a-pill has-icon is-plain">
                  <span className="ml-1 last:ml-0 py-1 truncate">یک طرفه</span>
                  <svg
                    viewBox="0 0 24 24"
                    width="1em"
                    height="1em"
                    fill="currentColor"
                    className="a-pill-dropdown__caret mr-1"
                    data-dropdown-id="al3074031"
                  >
                    <path
            ...
            <div className="flex w-full items-stretch justify-center">
              <div style={{ flex: "0 1 41.6667%", marginLeft: "8px" }}>
                <div
                  className="is-searchable a-select"
                  style={{ position: "relative" }}
                >
                  <div className="a-input-group is-horizontal relative mb-0">
                    <div className="a-input is-first is-lg">
                      <span className="a-input__input">
                        <input
                          id="al3096675"
                          className=""
                          data-dropdown-id="al3121961"
                        />
                      </span>
                      <fieldset>
                    ...
                    <span className="input-group-swap-btn">
                      <button
                        type="button"
                        className="btn is-null is-null-primary is-disabled p-0"
                        aria-label="swap"
                      >
                        <svg
                          viewBox="0 0 24 24"
                    ...
                    <div className="a-input is-last is-lg">
                      <span className="a-input__input">
                        <input
                          id="al3102256"
                          className=""
              ...
              <div
                className="relative"
                style={{ flex: "0 1 25%", marginLeft: "8px" }}
              >
                <div className="relative">
                  <div className="a-input-group is-horizontal is-placeholder">
                    <div className="a-input is-first is-lg">
                      <span className="a-input__input">
                        <input
                          id="al3048555"
                          className=""
                          data-dropdown-id="al3088553"
                        />
                      </span>
                      <fieldset>
                        <legend style={{ width: "0px" }}></legend>
                    ...
                    <span className="a-input-group__separator"></span>
                    <div className="a-input is-last is-disabled has-append is-lg">
                      <span className="a-input__input">
                        <input
                          id="al3050942"
                          data-datepicker-focus="1"
                          className=""
                          data-dropdown-id="al3088553"
                        />
                        {/* <span>
                  ...
                  <span className="help-text text-danger-400 mt-1"></span>
                </div>
              </div>
              <div
                style={{ flex: "0 1 16.666666666666668%", marginLeft: "8px" }}
              >
                <div>
                  <div className="a-input is-active is-lg">
                    <span className="a-input__input">
                      <input id="al3113085" className="" />
                    </span>
                    <fieldset>
                      <legend style={{ width: "55.5px" }}></legend>
                    </fieldset>
                    <label
                      htmlFor="al3113085"
                      className="a-input__label"
              ...
              <div style={{ flex: "0 0 16.6667%" }}>
                <button
                  type="button"
                  className="btn is-lg is-solid-primary is-block h-full"
                  name="search"
                >
                  جستجو
                </button>
